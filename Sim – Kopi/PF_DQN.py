...
class DQN_Agent:
    ...
    def evaluate(self, ep):
        ...
        psi_c_array = [-20, -60, 90, 60, 0]
        #psi_c_array = [0,0,0,0,0]
        #dist_array = [-50, 75, -100, 150, 0]
        dist_array = [-100, 200, -200, 150, 300]
        average_reward = 0
        ...
        for i in range(len(psi_array)):
            ...
            print(f'Evaluative reward for psi = {psi_array[i]-psi_c_array[i]}, psi_c = {psi_c_array[i]} and starting position in y = {dist_array[i]} was: {ep_reward}')
