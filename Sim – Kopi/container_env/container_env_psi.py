...
class ContainerEnv(gym.Env):
    ...
    def step(self, action, psi_c):
        if self.psi_c != psi_c:
            self.psi_c = psi_c
            self.pf_origin = [self.ship.xpos, self.ship.ypos]
    ...
    def reset(self):
        ...
        pf_pos = [x_init - self.pf_origin[0], y_init - self.pf_origin[1]]
    ...
    def _take_action(self, action_idx):
        ...
        self.ct_error, self.pf_psi, self.r, self.u, self.v = self.controller.autopilot(self.ship, self.pf_origin, self.psi_c, delta_c, self.u, self.v)
...
class Controller(object):
    ...
    def autopilot(self, ship, pf_origin, psi_c, delta_c, u, v):
